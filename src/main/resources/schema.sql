...
CREATE TABLE title_akas_types (
    ...
    CONSTRAINT fk_title_akas_types_title_akas FOREIGN KEY (title_id) REFERENCES title_akas (title_id),
    CONSTRAINT fk_title_akas_types_title_types FOREIGN KEY (type_id) REFERENCES title_types (type_id)
);
...
CREATE TABLE titles_genres (
    ...
    CONSTRAINT fk_titles_genres_titles FOREIGN KEY (title_id) REFERENCES titles (tconst),
    CONSTRAINT fk_titles_genres_genres FOREIGN KEY (genre_id) REFERENCES genres (genre_id)
);
...
CREATE TABLE known_for (
    ...
    CONSTRAINT fk_known_for_persons FOREIGN KEY (nconst) REFERENCES persons (nconst),
    CONSTRAINT fk_known_for_titles FOREIGN KEY (tconst) REFERENCES titles (tconst)
);
...
CREATE TABLE title_crew (
    ...
    CONSTRAINT fk_title_crew_titles FOREIGN KEY (tconst) REFERENCES titles (tconst),
    CONSTRAINT fk_title_crew_persons FOREIGN KEY (nconst) REFERENCES persons (nconst),
    CONSTRAINT ck_crew_type CHECK (type in ("director", "writer"))
);
...
CREATE TABLE episodes (
    ...
    PRIMARY KEY (tconst),
    CONSTRAINT fk_episodes_titles FOREIGN KEY (parent_tconst) REFERENCES titles (tconst)
);
...
CREATE TABLE principals (
    ...
    CONSTRAINT fk_principals_titles FOREIGN KEY (tconst) REFERENCES titles (tconst),
    CONSTRAINT fk_principals_persons FOREIGN KEY (nconst) REFERENCES persons (nconst)
);
...
CREATE TABLE principals_characters (
    ...
    CONSTRAINT fk_principals_characters_principals FOREIGN KEY (principal_id) REFERENCES principals (principal_id),
    CONSTRAINT fk_principals_characters_characters FOREIGN KEY (character_id) REFERENCES characters (character_id)
);
